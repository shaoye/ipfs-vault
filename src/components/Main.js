          ...
          <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '1224px', minWidth: '1200px' }}>
            <div className="content">
              ...
              <div className="card mb-3 mx-auto bg-warning" style={{ maxWidth: '600px' }}>
                <h2 className="text-dark text-monospace bg-warning"><b>Upload certificates</b></h2>
                  <form onSubmit={(event) => {
                    ...
                    <p>&nbsp;</p>
                    <button type="submit" className="btn-primary btn-block"><b>Click here to upload the file</b></button>
                  </form>
              </div>
              <p>&nbsp;</p>
